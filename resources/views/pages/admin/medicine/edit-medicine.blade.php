<div x-data="{editOpen:false}" class="inline">
    <button x-on:click="editOpen = true"
        ...
        <svg class="h-3 w-3" viewBox="0 0 16 16" fill="#f6f6f6">
            <path
            ...
            <form class=" p-4" action="/medicine/{{ $medicine->id }}" method="POST">
                ...
                <div class="mt-4">
                    ...
                    <x-input id="medicine_quantity" class="block mt-1 w-full" type="number" min="0"
                        name="medicine_quantity" :value="old('medicine_quantity')"
                        value="{{$medicine->medicine_quantity}}" required autofocus />
                </div>
                <div class="mt-4">
                ...
                <div class="mt-4">
                    ...
                    <x-input id="date_of_expiration" class="block mt-1 w-full" type="date" name="date_of_expiration"
                        :value="old('date_of_expiration')" value="{{$medicine->date_of_expiration}}" required
                        autofocus />
                </div>
                <div class="mt-4">
