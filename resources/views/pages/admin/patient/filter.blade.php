...
<div class="mr-4  relative inline-block text-left" x-data="{filterOpen:false}">
    ...
    <div x-show="filterOpen" x-cloak
        ...
        <a class="text-gray-700 block px-4 py-3 text-sm hover:bg-slate-100" href="{{ route('patient.index') }}">All</a>
        <a class="text-gray-700 block px-4 py-3 text-sm hover:bg-slate-100"
            href="{{ route('patient.index') }}/?role=teaching_staff">
            Teaching Staff
        </a>
        <a class="text-gray-700 block px-4 py-3 text-sm hover:bg-slate-100"
            href="{{ route('patient.index') }}/?role=non_teaching_staff">
            Non-Teaching Staff
        </a>
        <a class="text-gray-700 block px-4 py-3 text-sm hover:bg-slate-100"
            href="{{ route('patient.index') }}/?role=student">
            Student
        </a>
    </div>
</div>
